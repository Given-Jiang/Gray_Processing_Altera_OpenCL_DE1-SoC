...
set_module_property NAME Gray_Processing_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME Gray_Processing_system
set_module_property TOP_LEVEL_HDL_FILE Gray_Processing_system.v
set_module_property TOP_LEVEL_HDL_MODULE Gray_Processing_system
...
### SLAVE interface avs_graying_cra
add_interface avs_graying_cra avalon end
set_interface_property avs_graying_cra addressAlignment DYNAMIC
set_interface_property avs_graying_cra burstOnBurstBoundariesOnly false
set_interface_property avs_graying_cra explicitAddressSpan 0
set_interface_property avs_graying_cra holdTime 0
set_interface_property avs_graying_cra isMemoryDevice false
set_interface_property avs_graying_cra isNonVolatileStorage false
set_interface_property avs_graying_cra linewrapBursts false
set_interface_property avs_graying_cra maximumPendingReadTransactions 1
set_interface_property avs_graying_cra printableDevice false
set_interface_property avs_graying_cra readLatency 0
set_interface_property avs_graying_cra readWaitTime 1
set_interface_property avs_graying_cra setupTime 0
set_interface_property avs_graying_cra timingUnits Cycles
set_interface_property avs_graying_cra writeWaitTime 0
set_interface_property avs_graying_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_graying_cra ENABLED true
add_interface_port avs_graying_cra avs_graying_cra_read read Input 1
add_interface_port avs_graying_cra avs_graying_cra_write write Input 1
add_interface_port avs_graying_cra avs_graying_cra_address address Input 4
add_interface_port avs_graying_cra avs_graying_cra_writedata writedata Input 64
add_interface_port avs_graying_cra avs_graying_cra_byteenable byteenable Input 8
add_interface_port avs_graying_cra avs_graying_cra_waitrequest waitrequest Output 1
add_interface_port avs_graying_cra avs_graying_cra_readdata readdata Output 64
add_interface_port avs_graying_cra avs_graying_cra_readdatavalid readdatavalid Output 1
...
add_file Gray_Processing.v {SYNTHESIS SIMULATION}
