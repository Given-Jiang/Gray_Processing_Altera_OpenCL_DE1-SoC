...
(
   ...
   input logic resetn,
   // AVS avs_graying_cra
   input logic avs_graying_cra_read,
   input logic avs_graying_cra_write,
   input logic [3:0] avs_graying_cra_address,
   input logic [63:0] avs_graying_cra_writedata,
   input logic [7:0] avs_graying_cra_byteenable,
   output logic avs_graying_cra_waitrequest,
   output logic [63:0] avs_graying_cra_readdata,
   output logic avs_graying_cra_readdatavalid,
   ...
   // INST graying of graying_top_wrapper
   graying_top_wrapper graying
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq(kernel_irqs),
      // AVS avs_cra
      .avs_cra_read(avs_graying_cra_read),
      .avs_cra_write(avs_graying_cra_write),
      .avs_cra_address(avs_graying_cra_address),
      .avs_cra_writedata(avs_graying_cra_writedata),
      .avs_cra_byteenable(avs_graying_cra_byteenable),
      .avs_cra_waitrequest(avs_graying_cra_waitrequest),
      .avs_cra_readdata(avs_graying_cra_readdata),
      .avs_cra_readdatavalid(avs_graying_cra_readdatavalid),
      // AVM avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_read(gmem0_global_avm_read[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_write(gmem0_global_avm_write[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_burstcount(gmem0_global_avm_burstcount[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_address(gmem0_global_avm_address[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writedata(gmem0_global_avm_writedata[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_byteenable(gmem0_global_avm_byteenable[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_waitrequest(gmem0_global_avm_waitrequest[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdata(gmem0_global_avm_readdata[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdatavalid(gmem0_global_avm_readdatavalid[0]),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writeack(gmem0_global_avm_writeack[0]),
      // AVM avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_read(gmem0_global_avm_read[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_write(gmem0_global_avm_write[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_burstcount(gmem0_global_avm_burstcount[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_address(gmem0_global_avm_address[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writedata(gmem0_global_avm_writedata[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_byteenable(gmem0_global_avm_byteenable[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_waitrequest(gmem0_global_avm_waitrequest[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdata(gmem0_global_avm_readdata[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdatavalid(gmem0_global_avm_readdatavalid[1]),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writeack(gmem0_global_avm_writeack[1])
   );
...
(
   ...
   // AVM avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0
   output logic avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_read,
   output logic avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_write,
   output logic [4:0] avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_burstcount,
   output logic [29:0] avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_address,
   output logic [255:0] avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writedata,
   output logic [31:0] avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_byteenable,
   input logic avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_waitrequest,
   input logic [255:0] avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdata,
   input logic avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdatavalid,
   input logic avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writeack,
   // AVM avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0
   output logic avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_read,
   output logic avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_write,
   output logic [4:0] avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_burstcount,
   output logic [29:0] avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_address,
   output logic [255:0] avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writedata,
   output logic [31:0] avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_byteenable,
   input logic avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_waitrequest,
   input logic [255:0] avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdata,
   input logic avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdatavalid,
   input logic avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of graying_function_wrapper
   graying_function_wrapper kernel
   (
      ...
      // AVM avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_read(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_read),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_write(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_write),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_burstcount(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_burstcount),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_address(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_address),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writedata(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writedata),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_byteenable(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_byteenable),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_waitrequest(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_waitrequest),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdata(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdata),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdatavalid(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_readdatavalid),
      .avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writeack(avm_local_bb1_ld_memcoalesce_img_test_in_load_0_inst0_writeack),
      // AVM avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_read(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_read),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_write(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_write),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_burstcount(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_burstcount),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_address(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_address),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writedata(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writedata),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_byteenable(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_byteenable),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_waitrequest(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_waitrequest),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdata(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdata),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdatavalid(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_readdatavalid),
      .avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writeack(avm_local_bb1_st_memcoalesce_img_test_out_insertValue_0_inst0_writeack)
   );
